...
public class WeaponMap
{
    ...
    static
    {
        ...
        //new items
        StyleMap.put(ItemID.TUMEKENS_SHADOW, WeaponStyle.MAGIC);
        StyleMap.put(ItemID.EYE_OF_AYAK, WeaponStyle.MAGIC);
        StyleMap.put(ItemID.VOIDWAKER, WeaponStyle.MELEE);
        StyleMap.put(ItemID.VOIDWAKER_DEADMAN, WeaponStyle.MELEE);
    }
}