...
public class NexPlugin extends Plugin
{
	...
	@Getter
	private int zarosAttackCounter = 3;
	...
	public void onNpcChanged(NpcChanged npcChanged)
	{
		...
		if (nex == npcChanged.getNpc())
		{
			clientThread.invokeAtTickEnd(this::zarosAttackCounterSync);
		}
	}
	...
	private void zarosAttackCounterSync()
	{
		zarosAttackCounter = 3;
	}
