...
@PluginDescriptor(
	name = "Mafham Nightmare",
	description = "Mafham Nightmare",
	tags = {"nightmare", "Mafham"}
)
...
public class NightmarePlugin extends Plugin
{
	...
	private void onGameTick(final GameTick event)
	{
		...
		if (pendingNightmareAttack != null && ticksUntilNextAttack <= 2)
		{
			pendingNightmareAttack = null;
		}
